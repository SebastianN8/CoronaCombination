...
function scene:show( event )
    ...
    if ( phase == "will" ) then
        ...
        local myText = display.newText('Main Menu', display.contentCenterX, display.contentCenterY, native.SystemFont, 50)
        ...
        local button = widget.newButton
        {
            ...
            height = 100,
            cornerRadius = 2,
            fillColor = { default={1,0.9,1,1}, over={1,0.1,0.7,0.4} },
